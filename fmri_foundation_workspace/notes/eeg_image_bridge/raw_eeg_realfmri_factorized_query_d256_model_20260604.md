...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| factorized_query / posterior_P_PO_O | 0.6544 | 0.6561 | 0.4772 | 0.1789 | 0.2461 | 0.2016 | 0.0050 | 0.0170 |
...
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_factorized_query_d256_model_seed33/factorized_query_posterior_P_PO_O_summary.json`
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_factorized_query_d256_model_seed33/factorized_query_posterior_P_PO_O_predictions.npz`
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_factorized_query_d256_model_seed33/factorized_query_posterior_P_PO_O_history.csv`
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_factorized_query_d256_model_seed33/factorized_query_posterior_P_PO_O_best.pt`
