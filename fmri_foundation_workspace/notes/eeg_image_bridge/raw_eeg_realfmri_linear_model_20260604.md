...
- Model: `linear` with channel set `posterior_P_PO_O`.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| linear / posterior_P_PO_O | 0.6550 | 0.6545 | 0.4796 | 0.1749 | 0.1684 | 0.1523 | 0.0070 | 0.0150 |
...
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_linear_model_seed33/linear_posterior_P_PO_O_summary.json`
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_linear_model_seed33/linear_posterior_P_PO_O_predictions.npz`
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_linear_model_seed33/linear_posterior_P_PO_O_history.csv`
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_linear_model_seed33/linear_posterior_P_PO_O_best.pt`
