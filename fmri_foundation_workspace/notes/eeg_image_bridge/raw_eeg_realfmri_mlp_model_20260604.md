...
- Model: `mlp` with channel set `posterior_P_PO_O`.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| mlp / posterior_P_PO_O | 0.6513 | 0.6562 | 0.4787 | 0.1775 | 0.2131 | 0.1757 | 0.0040 | 0.0200 |
...
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_mlp_model_seed33/mlp_posterior_P_PO_O_summary.json`
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_mlp_model_seed33/mlp_posterior_P_PO_O_predictions.npz`
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_mlp_model_seed33/mlp_posterior_P_PO_O_history.csv`
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_mlp_model_seed33/mlp_posterior_P_PO_O_best.pt`
