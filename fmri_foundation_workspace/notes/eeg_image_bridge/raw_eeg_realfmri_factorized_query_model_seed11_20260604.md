...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| factorized_query / posterior_P_PO_O | 0.6582 | 0.6370 | 0.5022 | 0.1348 | 0.2288 | 0.1730 | 0.0030 | 0.0210 |
...
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_factorized_query_model_seed11/factorized_query_posterior_P_PO_O_summary.json`
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_factorized_query_model_seed11/factorized_query_posterior_P_PO_O_predictions.npz`
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_factorized_query_model_seed11/factorized_query_posterior_P_PO_O_history.csv`
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_factorized_query_model_seed11/factorized_query_posterior_P_PO_O_best.pt`
