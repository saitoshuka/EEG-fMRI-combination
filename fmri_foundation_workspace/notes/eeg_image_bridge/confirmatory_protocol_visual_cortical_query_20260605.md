...
- H1 is supported for real visual64 across seeds 11/33/77:
  ordered-query rank 0.7186 +/- 0.0232 vs shifted 0.4809; pooled rank
  0.7667 +/- 0.0074 vs shifted 0.4801.
- H2 is supported for real visual64 identity and proto256 identity, but not for
