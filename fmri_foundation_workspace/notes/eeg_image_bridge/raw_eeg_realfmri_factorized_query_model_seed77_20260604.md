...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| factorized_query / posterior_P_PO_O | 0.6465 | 0.6495 | 0.4841 | 0.1654 | 0.2447 | 0.1982 | 0.0080 | 0.0260 |
...
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_factorized_query_model_seed77/factorized_query_posterior_P_PO_O_summary.json`
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_factorized_query_model_seed77/factorized_query_posterior_P_PO_O_predictions.npz`
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_factorized_query_model_seed77/factorized_query_posterior_P_PO_O_history.csv`
- `fmri_foundation_workspace/results/eeg_image_bridge/things_fmri_external_validation/raw_eeg_factorized_query_model_seed77/factorized_query_posterior_P_PO_O_best.pt`
