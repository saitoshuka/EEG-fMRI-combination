...
- Model: `query_attention`
- PCA components: `8`
- CV: `grouped` grouped by `subject` with `5` folds requested
- Metrics: `results/natview_deep_query_pca8_corr_small_v1/metrics.csv`

## Mean Metrics Across Folds

| Model | ROI r mean | ROI r median | Positive ROI frac | Spatial r mean | R2 weighted | Latent r mean | Best epoch |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| eeg_deep_query_attention | 0.0007 | 0.0009 | 0.4920 | 0.0037 | -0.0318 | 0.0022 | 15.6 |
