...
- Metrics: `/home/sudaxin/projects/paired_data/results/natview_pilot_roi_offset10p5_sessioncv/metrics.csv`

## Mean Metrics Across Folds

| Model | ROI r mean | ROI r median | Spatial r mean | R2 weighted | Top-1 retrieval | Top-5 retrieval |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| eeg_ridge_roi | 0.0178 | 0.0195 | -0.0003 | -0.0078 | 0.0029 | 0.0194 |
| shifted_null_roi | 0.0022 | 0.0016 | 0.0011 | -0.0061 | 0.0032 | 0.0194 |
