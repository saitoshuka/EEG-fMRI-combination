...
- Target mode: `pca`
- PCA components: `24`
- CV: grouped by subject, `5` folds requested
- Metrics: `/home/sudaxin/projects/paired_data/results/natview_pilot_pca24/metrics.csv`

## Mean Metrics Across Folds

| Model | ROI r mean | ROI r median | Spatial r mean | R2 weighted | Top-1 retrieval | Top-5 retrieval |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| eeg_ridge_pca | 0.0001 | 0.0001 | -0.0005 | -0.0084 | 0.0028 | 0.0158 |
| shifted_null_pca | -0.0045 | -0.0036 | 0.0008 | -0.0023 | 0.0028 | 0.0187 |
| train_mean | 0.0000 | 0.0000 | 0.0001 | 0.0000 | 0.0035 | 0.0176 |
