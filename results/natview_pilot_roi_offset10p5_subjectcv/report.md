...
- Metrics: `/home/sudaxin/projects/paired_data/results/natview_pilot_roi_offset10p5_subjectcv/metrics.csv`

## Mean Metrics Across Folds

| Model | ROI r mean | ROI r median | Spatial r mean | R2 weighted | Top-1 retrieval | Top-5 retrieval |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| eeg_ridge_roi | 0.0092 | 0.0105 | -0.0039 | -0.0202 | 0.0031 | 0.0171 |
| shifted_null_roi | -0.0024 | -0.0039 | -0.0025 | -0.0022 | 0.0038 | 0.0169 |
